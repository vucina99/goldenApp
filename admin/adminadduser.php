...
if (strlen($_SESSION['adminusername']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $admin_id = $_SESSION['adminusername_id'];

        $sql = "INSERT INTO users (username, name_surname, email, password , admin_id)
        VALUES ('$username', '$name_surname', '$email', '" . md5($password) . "' , '$admin_id')";
                            ...
                            <div class="card">
                                <div class="card-body ">
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="modal-input form-outline form-white">
                                            <label class="form-label" for="formWhite">Admin</label>
                                            <input type="text" class="form-control text-dark" disabled name="admin" value="<?= $_SESSION['adminusername'] ?>" required id="formWhite" />
