                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody id="myTable">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo htmlentities($result->bank_acc_num); ?>
                                                </td>
                                                <td>
                                                    <?php echo htmlentities($result->credit_card_num ); ?>
                                                </td>
                                                <td>
                                                    <?php echo htmlentities($result->expdate ); ?>
                                                </td>
                                                <td>
                                                    <?php echo htmlentities($result->cvv ); ?> </td>
                                                <td>
                                                    <?php echo htmlentities($result->amount ); ?> </td>
                                                <td>
